...
class spatial_dataset(Dataset):
    ...
    def load_ucf_image(self, video_name, index):
        if video_name.split('_')[0] == 'HandstandPushups':
            ...
            path = self.root_dir + \
                video_name.split('_')[0]+'/separated_images/v_' + \
                video_name+'/v_'+video_name+'_'
...
class spatial_dataloader():
    ...
    def train(self):
        training_set = spatial_dataset(dic=self.dic_training,
    ...
    def validate(self):
        validation_set = spatial_dataset(dic=self.dic_testing,
                                         root_dir=self.data_path,
                                         mode='val',
                                         transform=transforms.Compose([
